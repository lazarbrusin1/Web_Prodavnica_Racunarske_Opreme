        ...
        <header className="site-header">
            ...
            <section className="hero-panel">
                <div className="hero-copy">
                    ...
                    <p>
                        <p>
    Veliki izbor računara, laptopova, komponenti i periferija po
    konkurentnim cenama. Pronađite opremu koja odgovara vašim
    potrebama, sve na jednom mestu!
</p>
                    </p>
            ...
            <Modal show={show} onHide={() => setShow(false)} centered>
                <Modal.Body className="p-4">
                    ...
                    <button className="btn add-to-cart-btn w-100" onClick={handleLogin}>
                        Prijava
                    </button>
                </Modal.Body>
            </Modal>
